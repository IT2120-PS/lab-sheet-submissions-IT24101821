setwd("C:\\Users\\USER\\OneDrive\\Desktop\\IT24101821_Lab_07")

##Question 01
#Part 1
#It asks to find P(X <= 10) . Following command gives the cumulative #probability (<=), lower.tail" argument equals to "TRUE".
...
#Part 1
#It asks to find P(X<=3). Following command gives the cumulative #probability (<=), if ""lower.tail" argument equals to "TRUE".
pexp (3, rate = 0.5,lower.tail = TRUE)

#Part 2
#It asks to find P(X4). This can find using "pexp" command as follows.
#You need to rearrange the probability statement as follows.
#P (X>4) 1-P(X=4)
#Then command will be as follows.
...
#Part 1
#It asks to find P(x) = 37.9 ) Following command gives the cumulative #probability (<), if ""Tower.tail" argument equals to "TRUE". #You need to rearrange the probability statement as follows.
#(x >= 37.9) = 1 - P(x < 37.9)
#Then command will be as follows.
...
#Here, value of "b". This can be done using "qnorm" command.
qnorm(0.012,mean = 36.8, sd = 0.4, lower.tail = TRUE)

#Part 4
#Let consider that the minimum temperature they want to find is "b".
#Then, P(x > b) = 1% = 0.01
#Here, the value of "b". This can be done using "qnorm" command.
